...
const DB_CONFIG = {
  order: { host: 'localhost', port: 6433, user: 'logistics', password: 'logistics_secret', database: 'order_db_test' },
  fleet: { host: 'localhost', port: 6434, user: 'logistics', password: 'logistics_secret', database: 'fleet_db_test' },
  routing: { host: 'localhost', port: 6435, user: 'logistics', password: 'logistics_secret', database: 'routing_db_test' },
  tracking: { host: 'localhost', port: 6436, user: 'logistics', password: 'logistics_secret', database: 'tracking_db_test' },
  dispatcher: { host: 'localhost', port: 6437, user: 'logistics', password: 'logistics_secret', database: 'dispatcher_db_test' },
  counterparty: { host: 'localhost', port: 6439, user: 'logistics', password: 'logistics_secret', database: 'counterparty_db_test' },
  invoice: { host: 'localhost', port: 6440, user: 'logistics', password: 'logistics_secret', database: 'logistics_invoices_test' },
}
