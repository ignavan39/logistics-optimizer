...
export class SettingsService {
  ...
  async seedDefaults(): Promise<void> {
    const defaults = [
      { key: SettingKey.COMPANY_NAME, value: 'ООО "Тест Компания"' },
      { key: SettingKey.COMPANY_INN, value: '1234567890' },
      { key: SettingKey.COMPANY_KPP, value: '000000000' },
      { key: SettingKey.COMPANY_ADDRESS, value: 'г. Москва, ул. Тестовая, д. 1' },
      { key: SettingKey.COMPANY_PHONE, value: '+7 (495) 123-45-67' },
      { key: SettingKey.COMPANY_EMAIL, value: 'test@test.test' },
